...
### 관리자페이지
   1. **상품 등록**</br>
   <img width="1278" alt="Image" src="https://github.com/user-attachments/assets/4243ea28-5585-4e8f-8879-3d6e0e09f20b" /><br>
      - 실시간으로 id 중복 확인
   ...
   2. **상품 수정**</br>
   <img width="1278" alt="Image" src="https://github.com/user-attachments/assets/2b8a29e7-0cf2-4e58-91f0-dcd9ab5d9507" /><br>
      - 수정시 해당 id를 통해 원하는 데이터만 수정하여 반영</br>

</br>

   3. **상품 삭제**</br>
   <img width="1278" alt="Image" src="https://github.com/user-attachments/assets/5339547b-863e-489d-a707-a549075634f5" /><br>
   ...
   4. **엑셀 다운로드**</br>
   <img width="1278" alt="Image" src="https://github.com/user-attachments/assets/c231c9df-53cd-4110-aaea-3dbe196bcb0d" /><br>
...
1. **메인페이지**</br>
   ...
   **:two:반응형**</br>
   <img width="1278" alt="Image" src="https://github.com/user-attachments/assets/07bce4ff-a91a-4036-a87b-16ec7fdc0bb4" /><br>
   - 스크롤시 top버튼 생성
   - top버튼 클릭시 페이지 상단 이동</br>
   - 스크롤시 카테고리바를 상단에 고정</br></br>
   
   **3️⃣페이지네이션**
  <img width="1278" alt="Image" src="https://github.com/user-attachments/assets/875b6bda-30b6-43ca-9dd5-277ac0e39d81" /><br>
...
2. **상품 상세 페이지**</br>
   ...
   **:one:상세페이지 이동 및 장바구니 담기**</br>
   <img width="1278" alt="Image" src="https://github.com/user-attachments/assets/a24b067c-bf91-4812-92f2-e11d6db9caac" />
...
3. **장바구니 페이지**</br>
   ...
   **:two:개수 수정**</br>
   <img width="1278" alt="Image" src="https://github.com/user-attachments/assets/eb7fa539-061c-4d9e-bf97-5b8d85c32b45" />
   - +, - 버튼 클릭시 수량과 가격에 반영
   ...
   **:three:장바구니 비우기**</br>
   <img width="1278" alt="Image" src="https://github.com/user-attachments/assets/058a5dc0-f465-40e2-90f0-36096bd80d0c" />
